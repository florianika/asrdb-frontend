...
const routes: Routes = [
  ...
  {path: 'form', loadComponent: () => import('./register-form/register-form.component').then(c => c.RegisterFormComponent)},
  {path: 'form/:id', loadComponent: () => import('./register-form/register-form.component').then(c => c.RegisterFormComponent)}
];
